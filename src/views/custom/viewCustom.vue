...
<template>
  <el-row>
    <el-col :span="8" class="view-span">
      <span>案件编号: </span>
      <span>{{ viewData.caseCode }}</span>
    </el-col>
    <el-col :span="8" class="view-span">
      <span>客户姓名: </span>
      <span>{{ viewData.customName }}</span>
    </el-col>
    <el-col :span="8" class="view-span">
      <span>性别: </span>
    ...
    <el-col :span="8" class="view-span">
      <span>出生日期: </span>
      <span>{{ viewData.bornTime }}</span>
    </el-col>
    <el-col :span="8" class="view-span">
      <span>民族: </span>
      <span>{{ viewData.family }}</span>
    </el-col>
    <el-col :span="8" class="view-span">
      <span>联系方式: </span>
    ...
    <el-col :span="8" class="view-span">
      <span>邮政编码: </span>
      <span>{{ viewData.sendCode }}</span>
    </el-col>
    <el-col :span="24" class="view-span">
      <span>备注: </span>
